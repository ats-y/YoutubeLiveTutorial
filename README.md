...
配信予定を作成するとライブ配信URLをコピーできるので、試聴してもよい人にURLを伝えます。
...
自分のYoutube Studioから確認する方法と視聴者にどう見えるか確認する方法を説明します。
...
「配信予定」の一覧から確認したいライブ配信の行にマウスカーソルをあて、オプションボタンをクリックします。
...
「動画の詳細」画面で、ライブ配信を作成した際に入力した内容を編集できます。
左側のメニューの「詳細」「カスタマイズ」をクリックして設定内容を表示します。
...
今回のチュートリアルを作成するにあたって、サムネイル画像は [Canva](https://www.canva.com/ja_jp/)というデザインサイトで作成しました。 

以下では、サムネイル用の画像ファイルが既に用意されている前提で説明します。
...
「配信予定」の一覧からURLを取得したいライブ配信の行にマウスカーソルをあて、オプションボタンをクリックします。
